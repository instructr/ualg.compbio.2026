...
```{r old_histogram, eval=FALSE, echo=FALSE}
...
**Note** | A **boxplot** represents the distribution of a continuous variable.
...
**Note** | A **barplot** represents the distribution of a **categorical variable** or the summary of a continuous variable across categories.
